import { DataTexture, FloatType, RGBAFormat, LinearFilter } from "three";
...
const FALSECOLOR_GRADIENT: FalsecolorStop[] = [
	{ position: 0.0, r: 0.0, g: 0.0, b: 0.2 },
	{ position: 0.1, r: 0.0, g: 0.0, b: 0.8 },
	{ position: 0.25, r: 0.0, g: 0.6, b: 1.0 },
	{ position: 0.4, r: 0.0, g: 0.9, b: 0.4 },
	{ position: 0.5, r: 0.4, g: 1.0, b: 0.0 },
	{ position: 0.6, r: 0.8, g: 0.9, b: 0.0 },
	{ position: 0.75, r: 1.0, g: 0.6, b: 0.0 },
	{ position: 0.9, r: 1.0, g: 0.2, b: 0.0 },
	{ position: 1.0, r: 0.8, g: 0.0, b: 0.0 },
];

function interpolateGradient(normalizedValue: number): [number, number, number] {
