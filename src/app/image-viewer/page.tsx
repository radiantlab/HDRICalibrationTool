	...
	return (
		<div className="bg-gray-300 text-black grid grid-cols-4 min-h-screen">
			<main className="bg-white col-span-4 m-8 mt-0 p-5 border-l border-r border-b border-gray-400">
				...
				<p>
					This page automatically displays the HDR images in the output
					directory: <span className="font-mono">{outputPath}</span>
				</p>
				<p>
					To delete images, navigate to tha directory using your file manager,
					and delete the corresponding file.
				</p>
				<p>
					You can list other HDR images temporarily by adding them using the
					button below.
				</p>
								...
								>
									...
									<div>
										...
										<p className="text-m font-medium">
											Evalglare: {evalGlare ? `${evalGlare} lx` : "Not present"}
										</p>
									</div>
								</div>
							);
