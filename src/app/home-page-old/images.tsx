...
export default function Images() {
	...
	const { devicePaths, responsePaths, filterImages, setConfig } =
		useConfigStore();
	...
	return (
		<div className="space-y-2">
			...
			<div className="flex flex-row gap-4">
				...
				<div className="inline-flex items-center space-x-1 text-gray-900">
					...
					<div className="flex items-center mb-1 space-x-1">
						<label htmlFor={"filter_images"}>{"Filter"}</label>
			...
			{dirError && (
				<div>
					All entered directories must contain at least 1 valid image type: jpg,
					jpeg, tif, tiff, or raw image formats
				</div>
			)}
			...
			<FileFieldRow
				...
				errorMessage={
					response_error ? "Please only enter files ending in .rsp" : ""
				}
			/>
