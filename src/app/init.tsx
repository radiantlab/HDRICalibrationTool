	...
	useEffect(() => {
		...
		invoke<string>("query_os_platform", {})
			.then(async (platform: any) => {
				...
				setSettings({
					radiancePath: contentsObject.radiancepath,
					hdrgenPath: contentsObject.hdrgenpath,
					dcrawEmuPath: contentsObject.dcrawemupath,
					outputPath:
						contentsObject.outputpath === "" || !contentsObject.outputpath
							? outputDefaultPath
							: contentsObject.outputpath, // queries backend for suggested place to store files
