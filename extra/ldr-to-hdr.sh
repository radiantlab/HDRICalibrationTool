...
# -z| Calibration Factoring amount
...
pfilt -1 -x $CONFIG_OUT_X -y $CONFIG_OUT_Y $TEMP_FILENAME > $TEMP_FILENAME_ALT
...
getinfo -a "VIEW= -vta -vv $CONFIG_VA_V -vh $CONFIG_VA_H" < $TEMP_FILENAME_ALT > $TEMP_FILENAME
